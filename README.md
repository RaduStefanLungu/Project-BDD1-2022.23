...
my_db_path.fetch_data_from_connection()         #ceci permet de faire une copie de la database dans la mémoire interne du programme
...
all = Attribute("*","TEXT",0,0,[])  # ceci est le fameux "SELECT * FROM R"
